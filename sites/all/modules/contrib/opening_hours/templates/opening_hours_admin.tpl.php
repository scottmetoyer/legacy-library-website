...
<script type="text/template" id="oho-instance-edit-template">
  <form action="." id="oho-instance-edit-form">
    <fieldset class="date-time">
      ...
      <br><input type="checkbox" id="twentyfourhours" class="twentyfourhours" <%if(twentyfourhours==1){%>checked<%} %>>Display 24 hours.<br>
	  <input type="checkbox" id="appointment" class="appointment" <%if(appointment==1){%>checked<%} %>>By appointment.<br>
    </fieldset>
