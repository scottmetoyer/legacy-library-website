...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix" <?php print $attributes; ?>>
	<div class="study-space__content">
		<div class="study-space__library-info">
			...
			<span>/</span>
			<span>
				<?php print t('Floor #'); ?><?php print $floor; ?>
			</span>
		</div>
		<h1>
			<?php print $title; ?>
		...
		<div class="study-space__type study-space__attribute">
			<h3 class="study-space__attribute-title">
				<?php print t('Type'); ?>
			</h3>
	...
	<aside class="study-space__sidebar-first">
		...
		<?php if (isset($link)) { ?>
		<a href="<?php print $link; ?>" class="study-space__reserve-space-button">
			<?php print t('Reserve a Space'); ?>
		</a>
		<?php } ?>
	</aside>
</article>
